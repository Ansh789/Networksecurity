...
from networksecurity.constant import mongodb
...
class TrainingPipelineConfig:
    def __init__(self):
        ...
        # ensure artifact directory exists when config is created
        try:
...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        # MongoDB (from .env)
        self.database_name = mongodb.DATABASE_NAME
        self.collection_name = mongodb.COLLECTION_NAME
